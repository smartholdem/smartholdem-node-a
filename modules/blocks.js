...
__private.list = function (filter, cb) {
	...
	if (params.limit > 250) {
		return cb('Invalid limit. Maximum is 250');
	}
			...
			modules.delegates.validateBlockSlot(block, function (err) {
				...
				function (err) {
					if (err) {
						...
						// * The check against database state passed (for instance sender has enough STH, votes are under 101, etc...)
